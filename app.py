...
**Not a substitute for professional medical advice or a qualified fact-checker.**
    ...
    example_claims = [
        ...
        "Govt. of Nigeria is restricting entry into the country for travellers "
        "from countries with more than 1000 cases domestically.",
    ]
    chosen_example = st.selectbox(
        "Try an example claim, or type your own below:", [""] + example_claims)

    claim_text = st.text_area(
        "Claim to check:", value=chosen_example, height=100,
